...
@Component({
  ...
  templateUrl: './administrador-tickets.component.html',
  styleUrls: ['./administrador-tickets.component.scss']
})
export class AdministradorTicketsComponent implements OnInit {
