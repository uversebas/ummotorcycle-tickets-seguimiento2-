...
@Component({
  selector: 'app-solicitudes-marketing',
  templateUrl: './solicitudes-marketing.component.html',
  styleUrls: ['./solicitudes-marketing.component.scss']
})
export class SolicitudesMarketingComponent implements OnInit {
