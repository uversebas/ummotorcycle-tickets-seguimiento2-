...
@Component({
  selector: 'app-quality-tickets',
  templateUrl: './quality-tickets.component.html',
  styleUrls: ['./quality-tickets.component.scss']
})
export class QualityTicketsComponent implements OnInit {
  ...
  constructor(private spinner: NgxSpinnerService,
    ...
    private consultarSolicitudes(): void {
      this.servicioTicket.obtenerTicketsCalidad().subscribe(
        (respuesta) => {
    ...
    private async validarIngreso(): Promise<boolean> {
      ...
      return this.usuarioActual.esCalidad;
    }
