...
@Component({
  ...
  templateUrl: './comercial-tickets.component.html',
  styleUrls: ['./comercial-tickets.component.scss']
})
export class ComercialTicketsComponent implements OnInit {
  ...
  constructor(private spinner: NgxSpinnerService,
    ...
    private consultarSolicitudes(): void {
      this.servicioTicket.obtenerTicketsComercial().subscribe(
        (respuesta) => {
